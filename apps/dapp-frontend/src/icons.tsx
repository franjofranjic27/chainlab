...
/**
 * Icons — stroke-only, 24×24 viewBox, Lucide-style proportions.
 * Hand-rolled inline SVG, ported from the design handoff (reference/icons.jsx).
 */
export type IconProps = SVGProps<SVGSVGElement> & { size?: number };

function Ic({ d, fill, size = 18, strokeWidth = 1.75, children, ...rest }: IconProps) {
  return (
    <svg
      className="ic"
      viewBox="0 0 24 24"
...
export const Icon = {
  ...
  Wallet: (p: IconProps) => (
    <Ic {...p}>
      ...
      <path d="M21 9H5a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-6a2 2 0 0 0-2-2Z" />
  ...
  Bell: (p: IconProps) => (
    <Ic {...p}>
      <path d="M6 8a6 6 0 0 1 12 0c0 7 3 8 3 9H3c0-1 3-2 3-9" />
